  ...
  projects: Project[] = [
    {
      ...
      images: [
        'assets/multitaste/1.png',
        'assets/multitaste/2.png',
        'assets/multitaste/3.png',
        'assets/multitaste/4.png',
        'assets/multitaste/5.png',
        'assets/multitaste/6.png',
        'assets/multitaste/7.png',
        'assets/multitaste/8.png',
      ],
